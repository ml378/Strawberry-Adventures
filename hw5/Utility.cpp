...
void Utility::render_background(ShaderProgram* program, GLuint texture_id) {
    float bg_vertices[] = {
        -9.375f, 7.5f,
        9.375f, 7.5f,
        9.375f, -7.5f,
    ...
    glVertexAttribPointer(program->get_tex_coordinate_attribute(), 2, GL_FLOAT, false, 0, bg_tex_coords);
    glEnableVertexAttribArray(program->get_tex_coordinate_attribute());
